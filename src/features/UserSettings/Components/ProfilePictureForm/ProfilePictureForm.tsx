...
function ProfilePictureForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative flex justify-center items-center pt-3">
      <button type="button" className="relative w-64 h-64 rounded-full bg-gray-200 focus:outline-none focus:shadow-outline-indigo">
        {image ? (
          <>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <span className="block ml-2 text-gray-500 font-medium text-base leading-6 text-center">Change Profile Picture</span>
          </div>
        )}
        <input
          type="file"
